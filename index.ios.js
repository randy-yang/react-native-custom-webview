/**
  Base on react-native 0.51 WebView
  @flow
*/
'use strict';
...
var CustomWebViewManager = NativeModules.CustomWebViewManager;
...
class WebView extends Component {
  ...
  render() {
    ...
    const viewManager = nativeConfig.viewManager || CustomWebViewManager;
  ...
  _getCommands = () => {
    return UIManager.getViewManagerConfig('CustomWebView').Commands;
  }
...
var CustomWebView = requireNativeComponent('CustomWebView', WebView, WebView.extraNativeComponentConfig);
