...
import com.pouchen.react.webview.events.TopLoadingErrorEvent;
import com.pouchen.react.webview.events.TopLoadingFinishEvent;
import com.pouchen.react.webview.events.TopLoadingStartEvent;
import com.pouchen.react.webview.events.TopMessageEvent;
...
public class ReactWebViewManager extends SimpleViewManager<WebView> {
  ...
  protected static final String REACT_CLASS = "PCCWebView";
...
//        super.setWebViewClient(null);
        // 用 new WebViewClient() 取代 null
        // 設成 null 的話，有時候會跳出 new browser，對公發機來說會造成安全問題
        super.setWebViewClient(new WebViewClient());
        mReactWebViewClient = null;
      } else {
