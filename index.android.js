...
var defaultRenderLoading = () => (
  <View style={styles.loadingView}>
    <ActivityIndicator size="large" style={styles.loadingProgressBar} />
  </View>
);
...
class WebView extends Component {
  ...
  render() {
    ...
    if (this.state.viewState === WebViewState.LOADING) {
      ...
      console.error('PCCWebView invalid state encountered: ' + this.state.loading);
    }
    ...
    let NativeWebView = nativeConfig.component || PCCWebView;
  ...
  getCommands = () => this.getViewManagerConfig('PCCWebView').Commands;
...
var PCCWebView = requireNativeComponent(
  'PCCWebView',
  WebView,
